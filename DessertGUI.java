...
public class DessertGUI extends JFrame {
    ...
    private void addRecipeToPanel(String name, String description, String category) {
    ...
    public static void main(String[] args) {
        DessertGUI frame = new DessertGUI(null);
